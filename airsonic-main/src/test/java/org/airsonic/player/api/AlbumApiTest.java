...
public class AlbumApiTest {
    ...
    @Nested
    class GetAlbumListTests {
        private final String clientName = "getAlbumListTestsClient";

        @BeforeEach
        void setup() {
            // Mock the media folder service to return a test folder
    ...
    @Nested
    class GetAlbumList2Test {

        private final String clientName = "getAlbumList2TestClient";
