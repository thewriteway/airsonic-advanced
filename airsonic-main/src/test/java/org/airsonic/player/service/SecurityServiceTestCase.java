...
public class SecurityServiceTestCase {
    ...
    public void testCreateGuestUserIfNotExists() throws Exception {
        ...
        // set encoder to the decodable AES-GCM encoder
        when(settingsService.getPreferNonDecodablePasswords()).thenReturn(false);
        when(settingsService.getDecodablePasswordEncoder()).thenReturn("encrypted-AES-GCM");
        ...
        PasswordDecoder decoder = (PasswordDecoder) PasswordEncoderConfig.ENCODERS.get("encrypted-AES-GCM");
